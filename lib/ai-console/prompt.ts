...
/**
 * The scope-locked persona for the co-pilot. Moved verbatim from
 * run-assistant.ts during the monolith split — every line here is read by the
 * model as-is, so edits to this file change the assistant's behaviour directly.
 */
