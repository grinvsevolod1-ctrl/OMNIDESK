...
export interface Manager {
  ...
  /**
   * Локальная аватарка сотрудника (миграция 152): квадратная картинка,
   * сжатая на клиенте и сохранённая как data:-URL. null — показываем инициалы.
   * Никаких сторонних хранилищ: изображение целиком лежит в БД.
   */
