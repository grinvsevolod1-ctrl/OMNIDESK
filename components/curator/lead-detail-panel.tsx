    ...
    <SlideOver open={leadId !== null} onClose={onClose} title="Карточка лида">
      {!card ? (
        ...
        >
          ...
          {/* Передача коллеге: кураторская панель, админ (любому активному
              менеджеру по кадрам) и руководитель с правом «редактирование»
              (внутри своей группы), пока лид не в архиве — из архива сначала
              верните лид. */}
          {(variant === 'curator' ||
            variant === 'admin' ||
