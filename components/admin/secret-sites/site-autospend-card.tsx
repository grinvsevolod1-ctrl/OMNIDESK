        ...
        <div className="flex flex-col gap-3">
          ...
          {state.autoSpend?.startDay && (
            <p className="text-xs text-muted-foreground">
              ...
              этой даты. Прошедшие дни зафиксированы: смена бюджета, остановка
              кампании или выключение авто-скрутки их не меняют, а повторное
              включение продолжает с того же места.
            </p>
          )}
