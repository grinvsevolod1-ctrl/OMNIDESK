 ...
 * the AI quotes real facts instead of hallucinating. Belongs only to the
 * manager brain — the client simulator never touches it.
 */
  ...
  return (
    <Card className="flex flex-col gap-4 p-4">
      <div className="flex items-start gap-3">
        ...
        <div>
          <p className="font-medium">База знаний (RAG)</p>
          <p className="text-sm text-muted-foreground">
            Точные факты — цены, условия, ответы на частые вопросы. ИИ находит
            релевантные записи по смыслу и использует их в ответах, не выдумывая
            цифры. Используется только «мозгом менеджера».
          </p>
        </div>
      </div>
              ...
              <div className="min-w-0">
                ...
                {!e.hasEmbedding ? (
                  <p className="mt-1 text-xs text-destructive">
                    Не проиндексировано (нет эмбеддинга) — не участвует в поиске.
                  </p>
                ) : null}
              </div>
              <Button
