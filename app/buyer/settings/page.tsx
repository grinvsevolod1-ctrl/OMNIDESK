...
const TABS: SettingsTab[] = [
  { id: 'profile', label: 'Профиль', hint: 'Имя, логин, почта', icon: 'user' },
  {
    id: 'notifications',
    label: 'Уведомления',
  ...
  { id: 'security', label: 'Безопасность', hint: 'Смена пароля', icon: 'key' },
  {
    id: 'twofa',
...
export default async function BuyerSettingsPage() {
  ...
  const notificationsPanel = (
    <Card className="p-5">
      ...
      <p className="mt-1 text-sm text-muted-foreground">
        Push-уведомления о новых лидах по вашим источникам приходят на это
        устройство даже при закрытой вкладке.
      </p>
      <div className="mt-4">
